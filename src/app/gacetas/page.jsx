...
export default function GacetasPage() {
        ...
        <Box className="box" id="sect-1" sx={{ flexGrow: 1 }}>
            <Grid className="grid" container spacing={5}>
                ...
                <Grid className="gacetas" item xs={10}  className="texto">
                    ...
                    <p>
                        Una gaceta oficial es la publicación oficial de un Estado donde se hacen del conocimiento público 
                        todas las leyes, decretos, resoluciones y demás actos normativos que emanan de los poderes públicos.
                        <br/>
    ...
    <div>
      ...
      >
        <Box sx={style}>
          <embed type="application/pdf" height="100%" width="100%" src="pdfs/gaceta1.pdf"/>
        </Box>
      </Modal>
    </div>
